...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_TOGETIC}),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_QWILFISH] =
    {
        .baseHP        = 75,
        .baseAttack    = 105,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 85 : 85,
        .baseSpeed     = 95,
        .baseSpAttack  = 55,
        .baseSpDefense = 55,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .baseDefense   = 140,
        .baseSpeed     = 50,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 110 : 110,
        .baseSpDefense = 110,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .baseAttack    = 65,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 105 : 105,
        .baseSpeed     = 45,
        .baseSpAttack  = 75,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 105 : 105,
    ...
    [SPECIES_MANTINE] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 85 : 85,
        .baseAttack    = 40,
        .baseDefense   = 70,
        .baseSpeed     = 70,
        .baseSpAttack  = 80,
