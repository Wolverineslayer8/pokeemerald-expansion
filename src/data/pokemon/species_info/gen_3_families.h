...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .baseDefense   = 75,
        .baseSpeed     = 85,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 95 : 95,
        .baseSpDefense = 45,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_EXPLOUD] =
    {
        ...
        .baseSpeed     = 78,
        .baseSpAttack  = 101,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 101 : 101,
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 245,
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .baseAttack    = 85,
        .baseDefense   = 85,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 90 : 90,
        .baseSpAttack  = 55,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FAIRY),
        .catchRate = 60,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .baseSpeed     = 95,
        .baseSpAttack  = 57,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 85 : 85,
    ...
    [SPECIES_CHIMECHO] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 75 : 75,
        .baseAttack    = 60,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 80 : 80,
        .baseSpeed     = 75,
        .baseSpAttack  = 105,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 90 : 90,
