...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .baseDefense   = 73,
        .baseSpeed     = 60,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 105 : 105,
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .baseDefense   = 120,
        .baseSpeed     = 40,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 110 : 110,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_WATER, TYPE_PSYCHIC),
        .catchRate = 75,
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_ONIX] =
    {
        ...
        .baseSpeed     = 90,
        .baseSpAttack  = 30,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 45 : 45,
        .types = MON_TYPES(TYPE_ROCK, TYPE_GROUND),
        .catchRate = 45,
    ...
    [SPECIES_SEADRA] =
    {
        ...
        .baseSpeed     = 95,
        .baseSpAttack  = 105,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 55 : 55,
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 75,
    ...
    [SPECIES_JYNX] =
    {
        ...
        .baseDefense   = 45,
        .baseSpeed     = 105,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 125 : 125,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_ICE, TYPE_PSYCHIC),
        .catchRate = 45,
    ...
    [SPECIES_ELECTABUZZ] =
    {
        ...
        .baseDefense   = 57,
        .baseSpeed     = 105,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 83 : 83,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_ELECTRIC),
        .catchRate = 45,
